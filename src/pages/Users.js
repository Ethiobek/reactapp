...
const Users = () => {
        ...
        <>
                ...
                <>
                  <Switch
                    ...
                    onChange={() => {
                      ...
                      setStatus(params?.row?.status === true ? false : true);
                    }}
                    size="small"
                  />
                </>
          ...
          >
            <Typography sx={{ textTransform: "capitalize" }} variant="body2">
              {params?.row?.status ? "Approved" : "Pending"}
            </Typography>
          </Alert>
        </>,
        <Button
  ...
  } = usePostData("users", userPostData);

  console.log("isSuccess : " + isAddUserSuccess);
  console.log("isLoading : " + postLoading);
  React.useEffect(() => {
    if (isSuccess) {
      refetch();
    }
  ...
  const { data, isLoading, isError, error, refetch } = useGetAllData("users");
  React.useEffect(() => {
    if (isAddUserSuccess && !postLoading) {
      reset({ fullName: "", email: "", phone: "", country: "", username: "" });
      handleClose();
    }
